<template>
  <div class="article-toc-panel bg-gray-50/70 border border-gray-200/80 rounded-lg p-3 w-full">
    <div class="toc-header font-bold text-gray-700 text-sm mb-3 flex items-center justify-between pb-2 border-b border-gray-200/60">
    ...
    <div v-else>
      <el-scrollbar :max-height="maxHeight">
        <div v-if="flatList.length === 0" class="text-gray-400 text-xs py-4 text-center">
          暂无章节大纲
        </div>
